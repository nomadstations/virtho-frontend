...
export default function LearningResourcesPage() {
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center bg-gray-50 px-4">
      <Helmet><title>Learning Resources - Virtho Foundation</title></Helmet>
      <div className="max-w-md w-full bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center" style={{ borderTop: '4px solid hsl(var(--zone-knowledge))' }}>
        ...
        <p className="text-gray-600 mb-6">A comprehensive library of educational materials across all disciplines is coming soon.</p>
