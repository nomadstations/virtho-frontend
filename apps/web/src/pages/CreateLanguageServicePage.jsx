...
function CreateLanguageServicePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Your language service has been added.',
      });
  ...
  return (
    <>
      <Helmet>
        <title>Create Language Service | Dashboard | Virtho Foundation</title>
        <meta name="description" content="Add a new language service to your portfolio" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <DashboardPageHeader
            title="Create Language Service"
            description="Add a new language service to your portfolio"
          />
...
export default CreateLanguageServicePage;